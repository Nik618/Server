...
public class MedicalcertificateId implements Serializable {
    private static final long serialVersionUID = -1537589421630554661L;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(receptionUsersId, diagnosisId, receptionTimesSheduleId, receptionTimesId, receptionTimesEmployeesId, id, receptionId);
    }
    ...
    public boolean equals(Object o) {
        ...
        MedicalcertificateId entity = (MedicalcertificateId) o;
